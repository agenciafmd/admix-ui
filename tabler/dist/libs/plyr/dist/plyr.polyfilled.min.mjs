...
const controls = {
    getIconUrl() {
        ...
        on.call(this, e, "keydown keyup", (i => {
            ...
            if (!s && ["Space", "ArrowRight"].includes(i.key)) controls.showMenuPanel.call(this, t, !0); else {
                let t;
                "Space" !== i.key && ("ArrowDown" === i.key || s && "ArrowRight" === i.key ? (t = e.nextElementSibling, is.element(t) || (t = e.parentNode.firstElementChild)) : (t = e.previousElementSibling, is.element(t) || (t = e.parentNode.lastElementChild)), setFocus.call(this, t, !0))
            }
...
class Fullscreen {
    constructor(e) {
        _defineProperty$1(this, "onChange", (() => {
            ...
            if (browser.isIos || !this.active || "Tab" !== e.key) return;
...
class Listeners {
    constructor(e) {
        _defineProperty$1(this, "firstTouch", (() => {
            ...
            const {player: t} = this, {elements: i} = t, {key: s, type: n, timeStamp: r} = e;
    ...
    handleKey(e) {
        ...
        if (c) {
            ...
            if (is.element(n)) {
                ...
                if ("Space" === e.key && matches(n, 'button, [role^="menuitem"]')) return
            }
...
var loadjs_umd = createCommonjsModule((function (e, t) {
    e.exports = function () {
        ...
        function o(t, i, s, n) {
            ...
            n = n || 0, /(^css!|\.css$)/.test(d) ? ((a = l.createElement("link")).rel = "stylesheet", a.href = m, (r = "hideFocus" in a) && a.relList && (r = 0, a.rel = "preload", a.as = "style")) : /(^img!|\.(png|gif|jpg|svg|webp)$)/.test(d) ? (a = l.createElement("img")).src = m : ((a = l.createElement("script")).src = t, a.async = void 0 === c || c), a.onload = a.onerror = a.onbeforeload = function (e) {
                var l = e.type[0];
                if (r) try {
